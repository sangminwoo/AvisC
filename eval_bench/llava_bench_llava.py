...
def eval_model(args):
    ...
    for line in tqdm(questions):
        ...
        conv = conv_templates[args.conv].copy()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image-folder", type=str, default="rips2024/examples/images")
    parser.add_argument("--question-file", type=str, default="rips2024/examples/questions.jsonl")
    parser.add_argument("--answers-file", type=str, default="rips2024/test/answer.jsonl")
    ...
    parser.add_argument("--conv", type=str, default="chatml_direct")
