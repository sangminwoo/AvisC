...
def eval_model(args):
    ...
    if dist.get_rank() == 0:
        ...
        experiment_dir = f"{args.log_path}/{model_string_name}/seed{args.seed}_{args.layer_gamma}_{args.lamb}"  # Create an experiment folder
...
if __name__ == "__main__":
    ...
    parser.add_argument("--log_path", type=str, default="path/logs/pope")
